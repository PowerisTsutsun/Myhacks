...
export function RegisterForm({ eventName = "MyHacks" }: RegisterFormProps) {
    ...
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
        ...
        <p className="text-xs text-white/25 leading-relaxed">
          ...
          shared with third parties. Visit{" "}
          <a href="/contact" className="underline hover:text-white/50 transition-colors">
            our contact page
          </a>{" "}
